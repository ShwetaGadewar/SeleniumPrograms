...
public class PharmacyFiveAutoSuggestion {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		search2.sendKeys("Pan");
		Thread.sleep(2000);
		List<WebElement> list = driver.findElements(By
				.xpath("//div[@class='c-PJLV c-bXbWpx c-bXbWpx-bZJlhX-direction-column c-bXbWpx-iieFQlv-css']/div/a"));
		int count = list.size();
